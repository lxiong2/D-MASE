...
%     x2_k(1:numbus2,iter+1) = x2_k(1:numbus,iter+1) + (slack2 - slack1);
%     x2_k(numbus2+1:(2*numbus-1),iter+1) = x2_k(numbus2+1:(2*numbus-1),iter+1) + ;
...
%     c_k(6,iter+1) = 1/numPart*(x1_k(6,iter+1) + x3_k(2,iter+1));
%     c_k(7,iter+1) = 1/numPart*(x2_k(5,iter+1) + x4_k(2,iter+1));
%     c_k(9,iter+1) = 1/numPart*(x2_k(7,iter+1) + x4_k(3,iter+1));
%     c_k(10,iter+1) = 1/numPart*(x3_k(3,iter+1) + x4_k(4,iter+1));
...
%     c_k(numbus+5,iter+1) = 1/numPart*(x1_k(10,iter+1) + x2_k(10,iter+1));
%     c_k(numbus+6,iter+1) = 1/numPart*(x1_k(11,iter+1) + x3_k(11,iter+1));
%     c_k(numbus+7,iter+1) = ;
%     c_k(numbus+9,iter+1) = 1/numPart*(x2_k(14,iter+1) + x4_k(6,iter+1));
%     c_k(numbus+10,iter+1) = ;
